...
addresses = Address.create!([
  { line_1: '20, Eccleston mews', postcode: 'SW1X 8AG', city: 'London', country: 'UK', address_type: 'Shipping/Billing', customer_id: 1},
  { line_1: '3, Lynwood road', postcode: 'SE28 8EE', city: 'Saltdean, Brighton', country: 'UK', address_type: 'Shipping/Billing', customer_id: 2 },
  { line_1: '55, Byrom street', postcode: 'WA14 2EL', city: 'Altrincham', country: 'UK', address_type: 'Shipping/Billing', customer_id: 3 },
  { line_1: '48, Bodenham road', postcode: 'HR1 2TP', city: 'Hereford', country: 'UK', address_type: 'Shipping/Billing', customer_id: 4 },
  { line_1: '41, Killiams Lane', postcode: 'TA1 3YA', city: 'Taunton', country: 'UK', address_type: 'Shipping/Billing', customer_id: 5 },
  { line_1: '3, Church Street', postcode: 'HP27 9AA', city: 'Princes Risborough', country: 'UK', address_type: 'Shipping/Billing', customer_id: 6 },
  { line_1: '41, Canal wharf', postcode: 'PO19 8EY', city: 'Chichester', country: 'UK', address_type: 'Shipping/Billing', customer_id: 7 },
  { line_1: '38, Babbington St', postcode: 'DE55 5QD', city: 'Tibshelf, Alfreton', country: 'UK', address_type: 'Shipping/Billing', customer_id: 8 },
  { line_1: '16, High st', postcode: 'PE6 8EB', city: 'Market Deeping, Peterborough', country: 'UK', address_type: 'Shipping/Billing', customer_id: 9 },
  { line_1: '49, Chantry rd', postcode: 'B13 8DN', city: 'Birmingham', country: 'UK', address_type: 'Shipping/Billing', customer_id: 10 },
  { line_1: 'Hanley Mill', postcode: 'WR15 8QT', city: 'Tenbury Wells', country: 'UK', address_type: 'Shipping/Billing', customer_id: 11 },
  { line_1: '12, Clock tower mews', postcode: 'N1 7BB', city: 'London', country: 'UK', address_type: 'Shipping/Billing', customer_id: 12 },
  { line_1: 'Ladle Hill House', postcode: 'RG20 9NR', city: 'Old Burghclere, Newbury', country: 'UK', address_type: 'Shipping/Billing', customer_id: 13 },
  { line_1: '3, The Chestnut, Easthampstead Rd', postcode: 'RG40 2EE', city: 'Wokingham', country: 'UK', address_type: 'Shipping/Billing', customer_id: 14 },
  { line_1: '10, Upper Bank st - ( Clifford Chance 11th floor)', postcode: 'E14 5JJ', city: 'London', country: 'UK', address_type: 'Shipping/Billing', customer_id: 15 },
  { line_1: 'Kuwait-Hutten-Blocky ST 15- Villa 74', postcode: 'E11 4EJ', city: 'Kuwait', country: 'Kuwait', address_type: 'Shipping/Billing', customer_id: 16 },
  { line_1: '1, Swansea Terrace', postcode: 'RG31 6HJ', city: 'Reading', country: 'UK', address_type: 'Shipping/Billing', customer_id: 17 },
  { line_1: '27a, Arragon rd', postcode: 'TW1 3NG', city: 'Twickenham', country: 'UK', address_type: 'Shipping/Billing', customer_id: 18 },
  { line_1: 'West wing, Mellerstain House', postcode: 'TD3 6LG', city: 'Gordon', country: 'UK', address_type: 'Shipping/Billing', customer_id: 19 },
  { line_1: '1, Greenfield close', postcode: 'SK22 3DG', city: 'New Mews, High Peak', country: 'UK', address_type: 'Shipping/Billing', customer_id: 20 },
  { line_1: '33, Prince Albert rd, Flat 22', postcode: 'NW8 7LU', city: 'London', country: 'UK', address_type: 'Shipping/Billing', customer_id: 21 },
  { line_1: 'Millicent, Lurgashall', postcode: 'GU28 9EP', city: 'Petworth', country: 'UK', address_type: 'Shipping/Billing', customer_id: 22 },
  { line_1: '31a, Market place', postcode: 'DL12 8NE', city: 'Barnard Castle', country: 'UK', address_type: 'Shipping/Billing', customer_id: 23 },
  { line_1: '13, Henning street', postcode: 'SW11 3DR', city: 'London', country: 'UK', address_type: 'Shipping/Billing', customer_id: 24 },
  { line_1: 'Bywell Castle', postcode: 'NE43 7AB', city: 'Stocksfield', country: 'UK', address_type: 'Shipping/Billing', customer_id: 25 }
  ])
